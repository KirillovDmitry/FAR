% итерационный метод прямого-обратного линейного предсказания
function  [eps_, phi_, ampl_, N, P, IT] = polp_iter_method(Ampl, Phaza, X, m, lamda, eps_true, limit,  N0, threshold, H, h, regl)
    if m>0
        eps = zeros(1,m);
        P = zeros(1,m);
        ampl = zeros(1,m);
